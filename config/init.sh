...
# ###
#
echo -e "\033[38;2;0;255;02mRuning ./config/init.sh \033[0m"
...
# ###
#
export N8N_HOST=n8n-12pd.onrender.com
export N8N_PORT=80
...
# #########################################################################################################
export APP_BASE_DIR=/opt/render/project/src/
export APP_CONFIG_DIR=/opt/render/project/src/config/
#
export N8N_CONFIG_DIR=/opt/render/.n8n/
# N8N_USER_FOLDER=/opt/render/project/src/config/
# ###
# export N8N_SSL_KEY=
# export N8N_SSL_CERT=
# ###
